...
class ReactMultiCrop extends Component {
  ...
  doubleClickEvent(options) {
    if (typeof options === 'object' && typeof options.target === 'object') {
      let { canvas } = this.state
  ...
  shapetoStructureData(element) {
    ...
    if (typeof canvas === 'object' && typeof canvas.backgroundImage === 'object') {
  ...
  render() {
    const { input, source, hideLabel, ...otherProps } = this.props
      ...
      <div id="canvas-wrapper">
        ...
        <Grid container
          ...
          <Grid item xs onKeyDown={this.keyboardHandler} tabIndex="0">
            <canvas width="800" height="800" style={{ border: '1px solid #aaa' }}{...otherProps} />
          </Grid>
          <Grid container item xs
            ...
            spacing={8}>
            <Grid item xs>
              <Button variant="contained" id="addmore" color="primary" onClick={this.addNew} > Add More Shapes</Button>
            </Grid>
            <Grid item xs>
              <Button variant="contained" id="deleteselected" color="primary" onClick={this.deleteShapes}> Delete Selected Object </Button>
            </Grid>
            <Grid item xs>
              <Button variant="contained" id="multiselect" color="primary" onClick={this.multiSelect}> Select All </Button>
            </Grid>
            <Grid item xs >
              <Button variant="contained" id="discard" color="primary" onClick={this.discardActiveObject}> Discard Selection</Button>
            </Grid>
          </Grid>
...
ReactMultiCrop.propTypes = {
  ...
  cropBackgroundColor: PropTypes.number,
